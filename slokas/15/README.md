...
```
cd existing_repo
git remote add origin https://code.swecha.org/yash_1206/learningpath_maker.git
git branch -M main
...
- [ ] [Set up project integrations](https://code.swecha.org/yash_1206/learningpath_maker/-/settings/integrations)
